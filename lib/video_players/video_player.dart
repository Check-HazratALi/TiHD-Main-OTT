...
import 'package:tihd/video_players/component/rent_details_component.dart';
            ...
            child: Center(
              child: LoaderWidget(),
                        ...
                        GestureDetector(
                          onTap: () {
                            AlertDialog(
                              title: Text(locale.value.rentDetails,
                                  style: boldTextStyle(size: 18)),
                              content: Text(
                                locale.value.rentedesc(videoModel.availableFor,
                                    videoModel.duration),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              locale.value.rentedesc(videoModel.availableFor,
                                  videoModel.accessDuration.toString()),
